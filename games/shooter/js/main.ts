namespace Shooter {
    ...
    class ShipController extends Component {
        ...
        public update(delta: number) {
            const gameObject = <Ship> this.gameObject;
    ...
    class BulletBehavior extends Component {
        ...
        public update(delta: number) {
            const gameObject = <Bullet> this.gameObject;
    ...
    class Bullet implements IGameObject {
        public components: Component[];
        public behavior: BulletBehavior;

        public position: Point;
        public image: BulletTexture;
